...
export default function NewEndClientContact({
  params,
}: {
  ...
  const { methods, onSubmit } = useEndClientContactForm({
    enterpriseRootId: Number(params.id),
    endClientId: Number(params.customerId),
  })
